...
public class Add_org_DBStore extends SQLiteOpenHelper {

    public static final String Database_Name="DATABASE_ORGANIZATION";
    public static final String Table_Name="TABLE_ORGANIZATION";
    public static final String Id="ID";
    public static final String Coloum1="ORG_NAME";
    public static final String Coloum2="ORG_ADDRESS";
    public static final String Coloum3="ORG_DISTRICT";
    public static final String Coloum4="ORG_CONTACT";
    Context context;
    public Add_org_DBStore(Context context) {
