...
public class Cloth_View_six extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloth__view_six);
        cloth_Specification= findViewById(R.id.cloth_specific_six);
        imageView_share= findViewById(R.id.share_six);
        setTitle("E-Commerce");
