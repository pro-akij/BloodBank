...
public class Cloth_View_three extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloth__view_three);
        cloth_Specification= findViewById(R.id.cloth_specific_three);
        imageView_share= findViewById(R.id.share_three);
        setTitle("E-Commerce");
    ...
    public void onClick(View v) {
        int id= v.getId();
        if (id== R.id.cloth_specific_three){
