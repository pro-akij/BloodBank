...
public class Cloth_View_five extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloth__view_five);
        cloth_Specification= findViewById(R.id.cloth_specific_five);
        imageView_share= findViewById(R.id.share_five);
        setTitle("E-Commerce");
    ...
    public void onClick(View v) {
        int id= v.getId();
        if (id== R.id.cloth_specific_five){
