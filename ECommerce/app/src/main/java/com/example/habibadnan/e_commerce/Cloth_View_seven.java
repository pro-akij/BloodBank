...
public class Cloth_View_seven extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloth__view_seven);
        cloth_Specification= findViewById(R.id.cloth_specific_seven);
        imageView_share= findViewById(R.id.share_seven);
        setTitle("E-Commerce");
    ...
    public void onClick(View v) {
        int id= v.getId();
        if (id==R.id.cloth_specific_seven){
